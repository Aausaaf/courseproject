...
import courseBannerImage1 from "../../Assets/reactBannerImage.jpg"
import courseBannerImage2 from "../../Assets/graphqlbannerImage.jpg"
import courseBannerImage3 from "../../Assets/angularBannerImage.jpg"
import courseBannerImage4 from "../../Assets/pythonBannerImage.jpg"
import courseBannerImage5 from "../../Assets/gatsbyBannerImage.jpg"
import { useProductContext } from '../../ApiIntegration/CoursesApi/CoursesApi';
import { useNavigate } from 'react-router';


const CoursesCartComp = ({
    image,
    price,
    title,
    duration,
...
const CyberShiksha = () => {
  ...
  const {CourseSiksha,CourseSikshaError,getCourseSiksha} = useProductContext()

  console.log(CourseSiksha?.data)
...
useEffect(()=>{
  ...
  return (<div className="cyber_shiksha_comp_main_container">
      <div className="cyber_shiksha_comp_header">
         <div className="border1"></div>
         <h1>CYBER SHIKSHA</h1>
         <div className="border2"></div>
        </div> 
        
        <div className="cyber_shiksha_comp_course1">
  ...
  {
    CourseSiksha?.data?.map((item)=>{
          return <SwiperSlide onClick={()=>{
            navigate(`/courseinfo/${item._id}`)
          }}>
                 <CoursesCartComp
                 title={item.name}
                 price={item.price}
            ...
            <div style={{
                marginTop:"5rem"
            }} className="cyber_shiksha_comp_course1">
  ...
  {
  CourseSiksha?.data?.reverse()?.map((item)=>{
          return <SwiperSlide onClick={()=>{
            navigate(`/courseinfo/${item._id}`)
          }}>
                 <CoursesCartComp
